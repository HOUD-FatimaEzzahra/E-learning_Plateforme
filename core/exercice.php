...
$result = $getExercice->getExercice3($id);
			...
			<div class="row">
				...
				<div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
					...
					<div class="container bg-light text-dark" style="width:90%; border-radius: 10px;margin:auto;">
						<br>
						<h4>Correction</h4>
						<?php if ($output['etat'] == 0) {
							echo " <div class='alert alert-warning' role='alert'>
							Pas de corrigée
						  </div><br>
							";
						} else {
							echo "<tr><td><i class='far fa-file-alt'></i></td><td><a class='blackk' href=corrige?idCorrection=" . $output['id_exercice'] . " > Voir la correction </a></td></tr><br>";
						} ?>
						<br>
					</div>
					<br>
